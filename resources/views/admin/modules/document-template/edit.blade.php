        ...
        <div class="card">
            ...
            <div class="card-body">
                @if(session()->has('error'))
                    ...
                    @endphp
                @endif
                <form action="{{ route('admin.document-template.update', Crypt::encryptString($data->id)) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <textarea name="isi_document" id="textBody" class="form-control @error('isi_document') is-invalid @enderror" >{!! old('isi_document') ?? $data->template !!}</textarea>
                                @error('isi_document')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
