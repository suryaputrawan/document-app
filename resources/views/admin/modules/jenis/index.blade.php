            ...
            <div id="item-layout" class="card-body" style="display: none">
                <form id="item-form">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-3">
                                <label class="form-label">Nama Jenis Dokument <span class="text-danger">*</span></label>
                                <input name="nama" id="name" type="text" class="form-control"
                                    placeholder="Contoh: Surat Tugas" value="{{ old('name') }}">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let dataTable = $("#datatable").DataTable({
            ...tableOptions,
            ajax: "{{ route('admin.jenis.index') }}?type=datatable",
            processing: true,
            serverSide : true,
            scrollX: true,
            responsive: false,
        ...
        // form environtment
        let ajaxUrl = "{{ route('admin.jenis.store') }}";
        let ajaxType = "POST";
        ...
        $("#btn-add").click(function() {
            ajaxUrl = "{{ route('admin.jenis.store') }}";
            ajaxType = "POST";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        ajaxUrl = "{{ route('admin.jenis.index') }}/"+response.data.id;
                        ajaxType = "PUT";
