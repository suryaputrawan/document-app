    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header flex flex-align-center">
                <h6 class="card-title flex-full-width mb-0">Permissions To Users</h6>
                <a href="{{ route('admin.assign.user.create') }}" type="button" class="btn btn-sm btn-primary btn-icon-text">
