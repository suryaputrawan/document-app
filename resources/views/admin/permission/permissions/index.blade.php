    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header flex flex-align-center">
                <h6 class="card-title flex-full-width mb-0">Permission List</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input name="guard_name" id="guard_name" type="text" class="form-control"
                                placeholder="Default: Web" value="{{ old('guard_name') }}">
                                <p id="error-guard" style="color: red" class="error"></p>
                            </div>
                        </div>
                    </div>
                    <hr class="mt-2">
    ...
    $(document).ready(function(){
        ...
        let dataTable = $("#datatable").DataTable({
            ...
            columns: [
                ...
                { data: "guard_name", name: "guard_name", orderable: true  },
            ],
