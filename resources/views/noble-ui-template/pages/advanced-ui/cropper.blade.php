...
@push('plugin-styles')
  <link href="{{ asset('assets/admin/plugins/cropperjs/cropper.min.css') }}" rel="stylesheet" />
@endpush
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-8">
            ...
            <div>
              <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="w-100" id="croppingImage" alt="cropper">
            </div>
