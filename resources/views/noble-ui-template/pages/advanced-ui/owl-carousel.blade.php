...
@push('plugin-styles')
  <link href="{{ asset('assets/admin/plugins/owl-carousel/assets/admin/owl.carousel.min.css') }}" rel="stylesheet" />
  <link href="{{ asset('assets/admin/plugins/owl-carousel/assets/admin/owl.theme.default.min.css') }}" rel="stylesheet" />
  <link href="{{ asset('assets/admin/plugins/animate-css/animate.min.css') }}" rel="stylesheet" />
@endpush
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="owl-carousel owl-theme owl-basic">
          <div class="item">
            <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" alt="item-image">
          </div>
          <div class="item">
            <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" alt="item-image">
          </div>
...
@push('plugin-scripts')
  <script src="{{ asset('assets/admin/plugins/owl-carousel/owl.carousel.min.js') }}"></script>
