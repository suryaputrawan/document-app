@extends('noble-ui-template.layout.master2')
          ...
          <div class="col-md-8 ps-md-0">
            <div class="auth-form-wrapper px-4 py-5">
              ...
              <form class="forms-sample">
                ...
                <div>
                  <a href="{{ url('noble-ui-3182/') }}" class="btn btn-primary me-2 mb-2 mb-md-0">Sign up</a>
                  <button type="button" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">
                    <i class="btn-icon-prepend" data-feather="twitter"></i>
                    Sign up with twitter
                  </button>
                </div>
                <a href="{{ url('noble-ui-3182/auth/login') }}" class="d-block mt-3 text-muted">Already a user? Sign in</a>
              </form>
            </div>
          </div>
        </div>
