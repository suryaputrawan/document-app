          ...
          <div class="col-lg-3 border-end-lg">
            <div class="aside-content">
              ...
              <div class="d-grid my-3">
                <a class="btn btn-primary" href="{{ url('noble-ui-3182/email/compose') }}">Compose Email</a>
              </div>
            <div class="email-aside-nav collapse">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center" href="{{ url('noble-ui-3182/email/inbox') }}">
