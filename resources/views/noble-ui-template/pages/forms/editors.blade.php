...
@push('plugin-styles')
  <link href="{{ asset('assets/admin/plugins/simplemde/simplemde.min.css') }}" rel="stylesheet" />
...
@push('plugin-scripts')
  ...
  <script src="{{ asset('assets/admin/plugins/simplemde/simplemde.min.js') }}"></script>
  <script src="{{ asset('assets/admin/plugins/ace-builds/ace.js') }}"></script>
  <script src="{{ asset('assets/admin/plugins/ace-builds/theme-chaos.js') }}"></script>
@endpush

@push('custom-scripts')
  <script src="{{ asset('assets/admin/js/tinymce.js') }}"></script>
  <script src="{{ asset('assets/admin/js/simplemde.js') }}"></script>
  <script src="{{ asset('assets/admin/js/ace.js') }}"></script>
@endpush