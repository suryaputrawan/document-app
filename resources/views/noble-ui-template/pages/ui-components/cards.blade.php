    ...
    <div class="example">
      <div class="row">
        <div class="col-12 col-md-6 col-xl-4">
          <div class="card">
              <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="card-img-top" alt="...">
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-12 col-md-6">
          <div class="card text-white">
            <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="card-img" alt="...">
