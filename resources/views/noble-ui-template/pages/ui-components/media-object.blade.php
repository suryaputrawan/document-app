@extends('noble-ui-template.layout.master')

@push('plugin-styles')
  <link href="{{ asset('assets/admin/plugins/prismjs/prism.css') }}" rel="stylesheet" />
@endpush
  ...
  <div class="col-xl-10 main-content ps-xl-4 pe-xl-5">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="wd-100 wd-sm-200 me-3" alt="...">
        <div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="wd-100 wd-sm-150 me-3" alt="...">
        <div>
          <h5 class="mb-2">Media heading</h5>
          ...
          <div class="d-flex align-items-start mt-3">
            <a class="me-3" href="#">
              <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="wd-100 wd-sm-150" alt="...">
            </a>
            <div>
              <h5 class="mb-2">Media heading</h5>
              Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="align-self-start wd-100 wd-sm-150 me-3" alt="...">
        <div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="align-self-center wd-100 wd-sm-150 me-3" alt="...">
        <div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="align-self-end wd-100 wd-sm-150 me-3" alt="...">
        <div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        ...
        <img src="{{ url('assets/admin/images/others/placeholder.jpg') }}" class="wd-100 wd-sm-150 ms-3" alt="...">
      </div>
    </div>
...
@push('plugin-scripts')
  <script src="{{ asset('assets/admin/plugins/prismjs/prism.js') }}"></script>
  <script src="{{ asset('assets/admin/plugins/clipboard/clipboard.min.js') }}"></script>
@endpush