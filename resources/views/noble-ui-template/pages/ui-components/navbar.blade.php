    ...
    <div class="example">
      ...
      <nav class="navbar navbar-light bg-light">
        <a class="navbar-brand" href="javascript:;">
          <img src="{{ url('assets/admin/images/others/logo-placeholder.png') }}" width="30" height="30" alt="">
        </a>
      </nav>
    </div>
...
<nav class="navbar navbar-light bg-light">
    ...
    <div class="example">
      ...
      <nav class="navbar navbar-light bg-light">
          <a class="navbar-brand" href="javascript:;">
            <img src="{{ url('assets/admin/images/others/logo-placeholder.png') }}" width="30" height="30" class="d-inline-block align-top" alt="">
            Logo
          </a>
        </nav>
    </div>
