    ...
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-header flex flex-align-center">
                <h6 class="card-title flex-full-width mb-0">Ubah {{ $breadcrumb }}</h6>
            ...
            <div class="card-body">
                @if(session()->has('error'))
                    ...
                    @endphp
                @endif
                <form action="{{ route('document.update', Crypt::encryptString($data->id)) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-sm-8">
                            <div class="mb-3">
                                ...
                                <input name="no_surat" type="text" class="form-control @error('no_surat') is-invalid @enderror"
                                    placeholder="Masukkan nomor surat" value="{{ old('no_surat') ?? $data->no_surat }}" autofocus>
                                @error('no_surat')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis_document" class="js-example-basic-single form-select @error('jenis_document') is-invalid @enderror" data-width="100%">
                                    ...
                                    <option value="{{ $item->id }}"
                                        {{ old('jenis_document', $data->jenis_id) == $item->id ? 'selected' : null }}>{{ $item->nama }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select name="diajukan_oleh" class="js-example-basic-single form-select @error('diajukan_oleh') is-invalid @enderror" data-width="100%">
                                    ...
                                    <option value="{{ $item->id }}"
                                        {{ old('diajukan_oleh', $data->pengirim_diajukan_oleh) == $item->id ? 'selected' : null }}>{{ $item->nama }}
                                    </option>
                                    @endforeach
                                </select>
                                @error('diajukan_oleh')
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select name="disetujui_oleh" class="js-example-basic-single form-select @error('disetujui_oleh') is-invalid @enderror" data-width="100%">
                                    ...
                                    @foreach ($karyawan as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('disetujui_oleh', $data->pengirim_disetujui_oleh) == $item->id ? 'selected' : null }}>{{ $item->nama }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <select name="recipient[]" class="js-example-basic-multiple form-select @error('recipient') is-invalid @enderror" data-width="100%" multiple="multiple">
                                    @foreach ($karyawan as $item)
                                        <option {{ $data->recipient()->find($item->id) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('recipient')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <select name="approval[]" class="js-example-basic-multiple form-select @error('approval') is-invalid @enderror" data-width="100%" multiple="multiple">
                                    @foreach ($karyawan as $item)
                                        <option {{ $data->approval()->find($item->id) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('approval')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <textarea name="isi_document" id="textBody" class="form-control @error('isi_document') is-invalid @enderror" >{{ old('isi_document') ?? $data->body }}</textarea>
                                @error('isi_document')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
